...
# Optional: Enable Windows DSR (Direct Server Return) Mode
# Enabling this option tells kube-proxy to enable DSR mode.
# This improves network performance and reduces the number of ports consumed for a service.
